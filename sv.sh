...
SV_MODES=("m_lda")   # default | denoise | denoise_layer | denoise_layer_split | denoise_val | clean_topic | clean_topic_val | ldp | ldp_by_layer | m_logistic | m_lda | lda | pca_align | pca_sv | pca_layer
