...
# MODELS=("llama_8b") # "llama_8b" "qwen_06b" "llama_3b" "llama_1b" "qwen_8b" "qwen_4b"
MODELS=("llama_8b")
...
MODES=("meta" "pca") # default | pca | meta | meta_attn | poly
COMPONENTS_LIST=(100)
TRAINING_SIZES=(-1) # -1 | 10 50 100 250 500
C_LIST=(1) # 0.01 0.1 1 10 
MAX_CHARS_LIST=(-1) # -1 | 50 100 150 200 250 300 400 500 600 800
MLP_DEPTH_LIST=(1)
SEEDS=(42)
                        ...
                        for MLP_DEPTH in "${MLP_DEPTH_LIST[@]}"; do
                            for MAX_CHARS in "${MAX_CHARS_LIST[@]}"; do
                                for SEED in "${SEEDS[@]}"; do
                                    ...
                                    echo "MLP_DEPTH=$MLP_DEPTH, SEED=$SEED, MAX_CHARS=$MAX_CHARS"
                                    echo "------------------------------------------------"
