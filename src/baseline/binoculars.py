...
class Binoculars(object):
    ...
    def __init__(self,
                 observer_name_or_path: str = "tiiuae/falcon-7b", # "tiiuae/falcon-7b" "Qwen/Qwen2.5-7B"
                 performer_name_or_path: str = "tiiuae/falcon-7b-instruct", # "tiiuae/falcon-7b-instruct" "Qwen/Qwen2.5-7B-Instruct"
