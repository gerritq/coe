...
class Binoculars(object):
    ...
    def __init__(self,
                 observer_name_or_path: str = "meta-llama/Meta-Llama-3-8B", # "tiiuae/falcon-7b"
                 performer_name_or_path: str = "meta-llama/Meta-Llama-3-8B-Instruct", # "tiiuae/falcon-7b-instruct"
