...
class PCASVBase(SVBase):
    """Fit PCA on activations first, then compute steering vectors in PCA space."""
    ...
    def run(self, args: Namespace) -> dict[str, Any]:
        ...
        # Requested order: compute SV only after projecting activations to PCA manifold.
