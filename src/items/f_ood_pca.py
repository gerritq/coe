...
METHOD_SPECS = {
    "probe_pca": {"kind": "probe", "mode": "pca"},
    "probe_meta": {"kind": "probe", "mode": "meta"},
...
def main() -> None:
    ...
    out_path = os.path.join(OUT_DIR, "ood_figure_pca.pdf")
    ...
    panel_methods = [
        ...
        ("LLP", _collect_method_entries("probe_pca")),
        ("CLP", _collect_method_entries("probe_meta")),
    ]
